...
//----------------------------------------------------------------------------------------------------------------------------
chromatic_thread_pool::chromatic_thread_pool (void)
  : active_threads_ ( 0L )
{
	//
}
...
//----------------------------------------------------------------------------------------------------------------------------
int chromatic_thread_pool::start ( int pool_size )
{
  return this->activate ( THR_NEW_LWP | THR_DETACHED , pool_size );
}

//----------------------------------------------------------------------------------------------------------------------------
int chromatic_thread_pool::stop ( void )
{
...
//----------------------------------------------------------------------------------------------------------------------------
int chromatic_thread_pool::enqueue (ACE_Event_Handler *handler)
{
...
//----------------------------------------------------------------------------------------------------------------------------
int chromatic_thread_pool::svc ( void )
{
  ...
  chromatic_counter_guard counter_guard ( active_threads_ );

   while (this->getq ( mb) != -1 )
  {
     
      chromatic_message_block_guard message_block_guard ( mb );
