...
const char * ::chromatic_imap_dds::chromatic_imap_commandTypeSupport::metaDescriptor[] = {"<MetaData version=\"1.0.0\"><Module name=\"chromatic_imap_dds\"><Struct name=\"chromatic_imap_command\">",
"<Member name=\"session_idx\"><Long/></Member><Member name=\"locale_idx\"><Long/></Member><Member name=\"moniker\">",
"<String/></Member><Member name=\"command\"><String/></Member><Member name=\"payload\"><String/></Member>",
