...
namespace OemoImapProtocolImpl
{
				...
				typedef OemoImapSearchResolver* OemoImapSearchResolverPtr;
				...
				class OemoImapSearchCriteria
				{
					...
					public:
						...
						//services
						void DeconstructCriteria( OemoImapSearchResolverPtr resolver );
				...
				class OemoImapSearchResolver : public OemoImapSearchResolverBase
				{
					public:
						...
						OemoImapSearchResolver( OemoImapMgrPtr ptrImapMgr , const std::string& isys_path );
