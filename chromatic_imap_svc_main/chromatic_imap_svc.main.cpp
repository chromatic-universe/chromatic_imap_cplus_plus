...
ACE_RCSID(Misc, main, "$Id: main.cpp 935 2008-12-10 21:47:27Z mitza $")
...
ACE_TMAIN (int argc, ACE_TCHAR *argv[])
{
  ...
  args.add (ACE_TEXT ("-d"));
  args.add (ACE_TEXT ("-S"));
  args.add (ACE_TEXT ("\"static Timer_Service_1 'ace_svc_lib 1 10 $TRACE'\""));
  args.add (ACE_TEXT ("-S"));
  args.add (ACE_TEXT ("\"dynamic Timer_Service_2 Service_Object * ace_svc_lib:_make_Timer_Service_2() 'ace_svc_lib 2 10 $TRACE'\""));
  // Test the -f option!
