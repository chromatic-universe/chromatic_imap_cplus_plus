//initial version June 2013 William K. Johnson
...
#include "chromatic_imap_daemon.h"


int
chromatic_imap_daemon::init (int argc, ACE_TCHAR *argv[])
{
...
// Listing 2 code/ch19
int
chromatic_imap_daemon::fini (void)
{
...
// Listing 3 code/ch19
int
chromatic_imap_daemon::info (ACE_TCHAR **str, size_t len) const
  {
...
// Listing 4 code/ch19
ACE_FACTORY_DEFINE (ACE_Local_Service, chromatic_imap_daemon)

ACE_STATIC_SVC_DEFINE (chromatic_imap_daemon_Descriptor,
                       ACE_TEXT ("chromatic_imap_daemon_Static_Service"),
                       ACE_SVC_OBJ_T,
                       &ACE_SVC_NAME (chromatic_imap_daemon),
                       ACE_Service_Type::DELETE_THIS |
                       ACE_Service_Type::DELETE_OBJ,
                       0)  // Service not initially active

ACE_STATIC_SVC_REQUIRE (chromatic_imap_daemon_Descriptor)
// Listing 4
